...
exports.RealtimeApiFp = exports.RealtimeApiFactory = exports.RealtimeApiAxiosParamCreator = exports.RealtimeApi = void 0;
 ...
 * @export
 */
const RealtimeApiAxiosParamCreator = function (configuration) {
  return {
    /**
    ...
    attachHuman: async (session, attachHumanRequest, options = {}) => {
      ...
      (0, _common.assertParamExists)('attachHuman', 'session', session);
      // verify required parameter 'attachHumanRequest' is not null or undefined
      (0, _common.assertParamExists)('attachHuman', 'attachHumanRequest', attachHumanRequest);
      ...
      localVarRequestOptions.data = (0, _common.serializeDataIfNeeded)(attachHumanRequest, localVarRequestOptions, configuration);
      return {
    ...
    dtmf: async (session, realtimeSessionDTMFRequest, options = {}) => {
      // verify required parameter 'session' is not null or undefined
      (0, _common.assertParamExists)('dtmf', 'session', session);
      // verify required parameter 'realtimeSessionDTMFRequest' is not null or undefined
      (0, _common.assertParamExists)('dtmf', 'realtimeSessionDTMFRequest', realtimeSessionDTMFRequest);
      ...
      localVarRequestOptions.data = (0, _common.serializeDataIfNeeded)(realtimeSessionDTMFRequest, localVarRequestOptions, configuration);
      return {
        url: (0, _common.toPathString)(localVarUrlObj),
        options: localVarRequestOptions
      };
    ...
    endRealtimeSession: async (session, xHumanId, options = {}) => {
      // verify required parameter 'session' is not null or undefined
      (0, _common.assertParamExists)('endRealtimeSession', 'session', session);
    ...
    getRealtimeSession: async (session, xHumanId, options = {}) => {
      // verify required parameter 'session' is not null or undefined
      (0, _common.assertParamExists)('getRealtimeSession', 'session', session);
    ...
    getRealtimeSessionMessages: async (session, xHumanId, options = {}) => {
      // verify required parameter 'session' is not null or undefined
      (0, _common.assertParamExists)('getRealtimeSessionMessages', 'session', session);
    ...
    getRealtimeSessionTimeline: async (session, xHumanId, options = {}) => {
      // verify required parameter 'session' is not null or undefined
      (0, _common.assertParamExists)('getRealtimeSessionTimeline', 'session', session);
    ...
    initiateOutboundCall: async (session, realtimeSessionInitiateOutboundCallRequest, options = {}) => {
      // verify required parameter 'session' is not null or undefined
      (0, _common.assertParamExists)('initiateOutboundCall', 'session', session);
      // verify required parameter 'realtimeSessionInitiateOutboundCallRequest' is not null or undefined
      (0, _common.assertParamExists)('initiateOutboundCall', 'realtimeSessionInitiateOutboundCallRequest', realtimeSessionInitiateOutboundCallRequest);
      ...
      localVarRequestOptions.data = (0, _common.serializeDataIfNeeded)(realtimeSessionInitiateOutboundCallRequest, localVarRequestOptions, configuration);
      return {
        url: (0, _common.toPathString)(localVarUrlObj),
        options: localVarRequestOptions
      };
    ...
    speak: async (session, speakRequest, options = {}) => {
      // verify required parameter 'session' is not null or undefined
      (0, _common.assertParamExists)('speak', 'session', session);
      // verify required parameter 'speakRequest' is not null or undefined
      (0, _common.assertParamExists)('speak', 'speakRequest', speakRequest);
      ...
      localVarRequestOptions.data = (0, _common.serializeDataIfNeeded)(speakRequest, localVarRequestOptions, configuration);
      return {
        url: (0, _common.toPathString)(localVarUrlObj),
        options: localVarRequestOptions
      };
    ...
    startRealtimeSession: async (startRealtimeSessionRequest, xHumanId, options = {}) => {
      ...
      (0, _common.assertParamExists)('startRealtimeSession', 'startRealtimeSessionRequest', startRealtimeSessionRequest);
      ...
      localVarRequestOptions.data = (0, _common.serializeDataIfNeeded)(startRealtimeSessionRequest, localVarRequestOptions, configuration);
      return {
        url: (0, _common.toPathString)(localVarUrlObj),
        options: localVarRequestOptions
      };
    ...
    updateRealtimeSession: async (session, realtimeSessionConfigUpdate, xHumanId, options = {}) => {
      // verify required parameter 'session' is not null or undefined
      (0, _common.assertParamExists)('updateRealtimeSession', 'session', session);
      // verify required parameter 'realtimeSessionConfigUpdate' is not null or undefined
      (0, _common.assertParamExists)('updateRealtimeSession', 'realtimeSessionConfigUpdate', realtimeSessionConfigUpdate);
      ...
      localVarRequestOptions.data = (0, _common.serializeDataIfNeeded)(realtimeSessionConfigUpdate, localVarRequestOptions, configuration);
      return {
        url: (0, _common.toPathString)(localVarUrlObj),
        options: localVarRequestOptions
      };
 ...
 * @export
 */
exports.RealtimeApiAxiosParamCreator = RealtimeApiAxiosParamCreator;
const RealtimeApiFp = function (configuration) {
  ...
  return {
    ...
    async attachHuman(session, attachHumanRequest, options) {
      ...
      const localVarOperationServerBasePath = _base.operationServerMap['RealtimeApi.attachHuman']?.[localVarOperationServerIndex]?.url;
    ...
    async dtmf(session, realtimeSessionDTMFRequest, options) {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath = _base.operationServerMap['RealtimeApi.dtmf']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) => (0, _common.createRequestFunction)(localVarAxiosArgs, _axios.default, _base.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
    },
    /**
     * End the RealtimeSession with the given identifier. 
    ...
    async endRealtimeSession(session, xHumanId, options) {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath = _base.operationServerMap['RealtimeApi.endRealtimeSession']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) => (0, _common.createRequestFunction)(localVarAxiosArgs, _axios.default, _base.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
    },
    /**
     * End the RealtimeSession with the given identifier. 
    ...
    async getRealtimeSession(session, xHumanId, options) {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath = _base.operationServerMap['RealtimeApi.getRealtimeSession']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) => (0, _common.createRequestFunction)(localVarAxiosArgs, _axios.default, _base.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
    },
    /**
     * Get all ContextMessages associated with the given RealtimeSession. 
    ...
    async getRealtimeSessionMessages(session, xHumanId, options) {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath = _base.operationServerMap['RealtimeApi.getRealtimeSessionMessages']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) => (0, _common.createRequestFunction)(localVarAxiosArgs, _axios.default, _base.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
    },
    /**
     * Get the timeline of the RealtimeSession with the given identifier. 
    ...
    async getRealtimeSessionTimeline(session, xHumanId, options) {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath = _base.operationServerMap['RealtimeApi.getRealtimeSessionTimeline']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) => (0, _common.createRequestFunction)(localVarAxiosArgs, _axios.default, _base.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
    },
    /**
     * Initiate an outbound call from a RealtimeSession. 
    ...
    async initiateOutboundCall(session, realtimeSessionInitiateOutboundCallRequest, options) {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath = _base.operationServerMap['RealtimeApi.initiateOutboundCall']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) => (0, _common.createRequestFunction)(localVarAxiosArgs, _axios.default, _base.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
    },
    /**
     * List all Realtime Sessions. 
    ...
    async listRealtimeSessions(xHumanId, options) {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath = _base.operationServerMap['RealtimeApi.listRealtimeSessions']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) => (0, _common.createRequestFunction)(localVarAxiosArgs, _axios.default, _base.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
    },
    /**
     * For a live session, force the agent to speak a given text.
    ...
    async speak(session, speakRequest, options) {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath = _base.operationServerMap['RealtimeApi.speak']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) => (0, _common.createRequestFunction)(localVarAxiosArgs, _axios.default, _base.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
    },
    /**
     * Start a new RealtimeSession with the given configuration. 
    ...
    async startRealtimeSession(startRealtimeSessionRequest, xHumanId, options) {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath = _base.operationServerMap['RealtimeApi.startRealtimeSession']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) => (0, _common.createRequestFunction)(localVarAxiosArgs, _axios.default, _base.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
    },
    /**
     * Update the RealtimeSession with the given identifier. 
    ...
    async updateRealtimeSession(session, realtimeSessionConfigUpdate, xHumanId, options) {
      ...
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath = _base.operationServerMap['RealtimeApi.updateRealtimeSession']?.[localVarOperationServerIndex]?.url;
      return (axios, basePath) => (0, _common.createRequestFunction)(localVarAxiosArgs, _axios.default, _base.BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
    }
  };
};
 ...
 * @export
 */
exports.RealtimeApiFp = RealtimeApiFp;
const RealtimeApiFactory = function (configuration, basePath, axios) {
 ...
 * @extends {BaseAPI}
 */
exports.RealtimeApiFactory = RealtimeApiFactory;
class RealtimeApi extends _base.BaseAPI {
  /**
   * Attaches a human to a RealtimeSession. This is useful for previously anonymous sessions, for example sessions created via a phone call.
   * @summary Attach a human to a RealtimeSession
   * @param {string} session The unique identifier of the RealtimeSession.
